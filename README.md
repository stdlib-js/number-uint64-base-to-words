...
```javascript
import toWords from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint64-base-to-words@deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint64-base-to-words@deno/mod.js';
```
